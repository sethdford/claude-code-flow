...
const success = (message: string) => console.log(green("✅"), message);
const error = (message: string) => console.log(red("❌"), message);
const warning = (message: string) => console.log(yellow("⚠️"), message);
const info = (message: string) => console.log(cyan("ℹ️"), message);
