...
echo "cd examples && ../bin/claude-flow swarm create 'Build hello world app based on simple workflow' --output ./output/hello"
echo ""
echo "# Run tests:"
echo "cd examples/04-testing/unit && ./test-memory-system.sh"
echo ""
echo "# Create your first swarm:"
echo "cd examples && ../bin/claude-flow swarm create 'Build a simple calculator'"
echo ""
echo "# Try SPARC TDD:"
echo "cd examples && ../bin/claude-flow sparc tdd 'Create user login function'"
echo ""
